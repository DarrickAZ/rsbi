...
public class CrossDataLoadServiceImpl extends ServiceSupport {
    public CrossDataLoadServiceImpl() {
    }
    ...
    public void execute(InputOption var1) throws ExtConfigException, IOException {
        ...
        var2.setAttribute("ext_fromAjax", "true");
        String var4 = var2.getParameter("reportId");
