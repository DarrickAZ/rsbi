...
public class ExtWriterPrintStreamImpl implements ExtWriter {
    private static Log a = LogFactory.getLog(ExtWriterPrintStreamImpl.class);
    ...
    public ExtWriterPrintStreamImpl(OutputStream var1) {
        this.b = var1;
    }
