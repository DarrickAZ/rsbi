...
public class OutputStreamWriterImpl implements ExtWriter {
    private static Log a = LogFactory.getLog(OutputStreamWriterImpl.class);
    private OutputStream b;

    public OutputStreamWriterImpl(OutputStream var1) {
        this.b = var1;
    }
