...
public class TextEmitter implements ContextEmitter {
    private ExtWriter a;
    private ExtRequest b;
    private ExtResponse c;
    private TextLayoutEnginer d;
    ...
    public void initialize(ExtWriter var1, ExtRequest var2, ExtResponse var3, ExtEnvirContext var4, InputOption var5, ServletContext var6) {
        ...
        this.b = var2;
        this.c = var3;
        this.d = new TextLayoutEnginer(var1, var2, var3, var4, var5);
        this.e = var4;
        this.f = var5;
        var4.put("outType", "text");
    }
