...
public class JSONEmitter implements ContextEmitter {
    private ExtWriter a;
    private ExtRequest b;
    private JSONLayoutEnginer c;
    ...
    public void initialize(ExtWriter var1, ExtRequest var2, ExtResponse var3, ExtEnvirContext var4, InputOption var5, ServletContext var6) {
        this.a = var1;
        this.b = var2;
        this.c = new JSONLayoutEnginer(var1, var2, var3, var4, var5);
        this.d = var4;
        this.e = var5;
        var4.put("outType", "json");
    }
