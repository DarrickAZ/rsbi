...
<script type="text/javascript" src="ext-res/js/jsencrypt.min.js"></script>
		...
		submitHandler:function(form){
			...
			$.ajax({
		        ...
		        success: function(data) {
					...
					var psd = encrypt.encrypt(form.password.value);
					var name = encrypt.encrypt(form.userName.value);
					func(name, psd);
		        }
		  })
		}    
             ...
             <form method="post" id="loginForm">
					...
					<div class="row">
						...
						<div class="form-group">
							<input type="text" name="userName" class="form-control uname" placeholder="您的账号" required="true" aria-required="true"/>
						</div>
						<div class="form-group">
							<input type="password" name="password" autocomplete="off" class="form-control pword m-b" placeholder="您的密码" required="true" aria-required="true"/>
						</div>
