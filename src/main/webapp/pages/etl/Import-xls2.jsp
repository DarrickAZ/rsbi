...
%>
function goback(){
	location.href = 'ImportXls.action?method=${param.method}&cfgid=${param.cfgid}';
}
</script>
...
<input type="hidden" id="impType" name="impType" value="xls">
...
<input type="hidden" name="cfgid" id="cfgid" value="${param.cfgid}">
 ...
 <tr>
    <td class="header hctx" width="120" height="50">文件名称：
    </td>
    <td colspan="1" class="hctx">${file.fileName} &nbsp; <button onclick="viewdata()" class="btn btn-default">数据预览</button></td>
</tr>
<tr>
   <td class="header hctx" height="50">Sheet页：</td>
   <td colspan="1" class="hctx">导入第 <input type="text" id="sheetIndex" name="sheetIndex" style="width:20px;" value="1"> 个Sheet页</td>
 </tr>
 <tr>
   <td height="50"></td>
   <td colspan="1" class="hctx">
    <div class="checkbox checkbox-info">
   <input type="checkbox" id="nameinhead" name="nameinhead" checked="checked">
   <label for="nameinhead">第一行数据作为标题</label>
   </div>
   </td>
 </tr>
 <tr>
    ...
    <input type="text" id="targettable" class="inputform" name="targettable" readonly="readonly"> <button type="button" class="btn btn-outline btn-info" onclick="selectTable()">选择</button> <button type="button" class="btn btn-outline btn-info" onclick="newtable()">新建</button>
    </td>
</tr>
<tr>
