...
<link href="../resource/css/style.css?v2" rel="stylesheet">
...
function exportPage(tp){
	...
	var ctx = "<form name='expff' method='post' action=\"export.action?"+pms+"\" id='expff'><input type='hidden' name='type' id='type' value='"+tp+"'><input type='hidden' name='pageId' id='pageId' value='${pageId}'><input type='hidden' name='picinfo' id='picinfo' value=\""+strs+"\"></form>";
	$(ctx).appendTo("body").submit().remove();
}
</script>
<style>
