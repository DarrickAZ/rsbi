 ...
 */
%>﻿<%@ page language="java" contentType="text/html; charset=utf-8" pageEncoding="utf-8" import="com.ruisitech.bi.util.RSBIUtils"%>
...
<title><c:if test="${pageName != null && pageName !=''}">${pageName} - </c:if>多维分析工具(OLAP)</title>
    ...
    <div>
		...
		<li class="dropdown">
        	...
        	<ul class="dropdown-menu">
				...
				<li><a href="javascript:saveas();">另存</a></li>
            </ul>
        </li>
		<li class="dropdown">
        	<a href="#" class="dropdown-toggle" data-toggle="dropdown">
					...
					<div class="tab-content">
                        ...
                        <div id="tab-2" class="tab-pane">
                            <div class="panel-body">
                               ...
                               <div id="chartarea" style="padding:5px; overflow:auto;"></div>
                            </div>
                        </div>
                    </div>
