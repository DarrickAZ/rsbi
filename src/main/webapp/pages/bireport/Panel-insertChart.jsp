...
<li <c:if test="${tp == 'map'}">class="select"</c:if> cid="8">地图</li>
</ul>
</div>
<div class="selright">
...
<div class="one" id="schart8" align="center" tp="map">
<img src="../resource/img/chart/c8.gif"><p/>
地图区域：<select id="maparea">
<option value="china,全国">全国</option>
<c:forEach var="ent" items="${ areas }">
<option value="${ent.code},${ent.provName}">${ent.provName}</option>
</c:forEach>
</select>
</div>
</div>
